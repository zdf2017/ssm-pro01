package com.ssmsite.common.interceptor;
...
public class LogsInterceptor extends HandlerInterceptorAdapter {
	...
	private static Logger logger = Logger.getLogger(LogsInterceptor.class);
   ...
   /* @Autowired
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
    	if(modelAndView != null){//输出视图地址
    		logger.info("视图地址:"+modelAndView.getViewName());
    	}
    }
